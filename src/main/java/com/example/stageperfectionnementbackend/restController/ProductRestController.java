...
import com.example.stageperfectionnementbackend.message.Response;
import com.example.stageperfectionnementbackend.message.ResponseFile;
import com.example.stageperfectionnementbackend.service.ProductPhotoService;
import com.example.stageperfectionnementbackend.service.ProductService;
...
public class ProductRestController {
    ...
    @RequestMapping(value = "productsCategory/{idCat}",method = RequestMethod.GET)
    public List<Product> getProductsByCategoryId(@PathVariable("idCat") Long idCat){
        return productService.findByCategoryId(idCat);
    }
    @RequestMapping(value = "productsByName/{prodsName}", method = RequestMethod.GET)
    public List<Product> getProductsByName(@PathVariable("prodsName")String prodsName){
        return productService.findByNameContains(prodsName);
    }
}
